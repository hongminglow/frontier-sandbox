...
export const BreedCard = ({ dog }: { dog: DogProfile }) => (
  <article className="breed-card group relative aspect-[4/3] min-h-0 overflow-hidden rounded-2xl border border-white/60 bg-[var(--card-bg)] shadow-[var(--card-shadow)] dark:border-white/10">
    <div
